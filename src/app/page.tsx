        ...
        <div className="flex flex-col gap-5">
          {SITES.map((site) => {
            ...
            const content = (
              <>
                ...
                <span className="flex min-w-0 flex-col">
                  ...
                  <span className="text-sm text-[#9a8767]">
                    {site.blurb}
                  </span>
                </span>
            ...
            return site.external ? (
              ...
              <Link key={site.id} href={site.href} className={className}>
                {content}
              </Link>
            );
          })}
